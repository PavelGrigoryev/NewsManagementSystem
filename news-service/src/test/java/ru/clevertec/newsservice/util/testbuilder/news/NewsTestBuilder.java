...
public class NewsTestBuilder implements TestBuilder<News> {
    ...
    private String text = "Apple has announced its latest flagship smartphone, the iPhone 15, which features" +
                          " a revolutionary holographic display that projects 3D images in mid-air. The iPhone 15 also" +
                          " boasts a faster processor, a longer battery life, and a new design that is thinner and" +
                          " lighter than ever. The iPhone 15 will be available in stores starting from July 1st.";
